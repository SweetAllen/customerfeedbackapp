...
} from "react-native";import Suggestions from "../component/Suggestions";
...
const Badsuggestions =()=> {
  const [ isPress, setIsPress ] = useState(false);
   ...
   const data = Questions.badquestions;
   ...
   const toggleKeyword = (keyword) => {
    ...
    return (
      ...
      <View >
       <Suggestions text="Royal Express ၏ ဝန်ဆောင်မှုနှင့်ပတ်သတ်၍
အဓိကပြုပြင်ဖို့လိုနေသည့် အချက်မှာ"/>
